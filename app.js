    ...
    if (key === 'featuredSeries') {
      btn.onclick = () => {
        ...
        modal.innerHTML = `
          ...
          <p>Stay tuned-in to the following series down below!</p>
          <ul style="list-style:none; padding:0;">
            <li style="margin-bottom:0.7rem;"><a href="https://www.sro-motorsports.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">SRO Motorsports</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.formula1.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">Formula 1 🏎️</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.fiawec.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">FIA WEC</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.formulad.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">Formula Drift 🛞💨</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://supergt.net/en/" target="_blank" style="color:#39ff14; text-decoration:underline;">Super GT</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://gplb.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">Grand Prix of Long Beach</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.petersen.org/" target="_blank" style="color:#39ff14; text-decoration:underline;">Petersen Museum</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.performanceracing.com/tradeshow" target="_blank" style="color:#39ff14; text-decoration:underline;">PRI</a></li>
            <li style="margin-bottom:0.7rem;"><a href="https://www.sema.org/" target="_blank" style="color:#39ff14; text-decoration:underline;">SEMA</a></li>
          </ul>
...
function renderDropdownMenu() {
  ...
  menu.style.minWidth = '180px';
    menu.innerHTML = `
      ...
      <div style="margin-top:1rem; border-top:1px solid #39ff14; padding-top:1rem;"><strong>VIBE RACING</strong></div>
      <div class="menu-item" style="cursor:pointer; color:#39ff14;" id="about-us-menu">ℹ️ About Us</div>
      ...
      <div class="menu-item" style="cursor:pointer; color:#39ff14;" onclick="window.showCategoryInfo('featuredSeries')">🏎️ Learn more about the Motorsports Series and Institutions!</div>
    `;
    setTimeout(() => {
      const aboutUsBtn = document.getElementById('about-us-menu');
      if (aboutUsBtn) {
        aboutUsBtn.onclick = function() {
          let modal = document.getElementById('aboutus-modal');
          if (modal) modal.remove();
          modal = document.createElement('div');
          modal.id = 'aboutus-modal';
          ...
          modal.style.boxShadow = '0 4px 24px #000';
          modal.innerHTML = `
            <h2 style='color:#39ff14; margin-bottom:1rem;'>About Us</h2>
            <p style='margin-bottom:1rem;'>VIBE RACING is a fast-developed prototype application created by an aspiring motorsports community engagement manager, with the help from AI.<br><strong>A.K.A, Vibe-Coded app!</strong><br><br>Hello and Welcome! VIBE RACING is an early prototype I built in collaboration with AI.<br><br><strong>Please note:</strong> as this is a prototype, the Sign-Up and Products pages are simulations and will not request or store any real payment information.<br><br>I hope you enjoy the prototype, and I encourage you to check out the motorsports series featured throughout the app.<br><br>If you’d like to support my work, feel free to give me a follow. Thank you all in advance!<br><br>-Nathan</p>
            <div style='margin-bottom:1rem;'>
              <a href="https://www.instagram.com/nate_mk_7.5/" target="_blank" style="color:#39ff14; text-decoration:underline; font-size:1.1rem;">
                Instagram: @nate_mk_7.5
              </a>
            </div>
            <button id='close-aboutus-modal' style='margin-top:1.5rem; background:#39ff14; color:#222; border:none; border-radius:6px; padding:0.5rem 1.2rem; cursor:pointer; font-size:1rem;'>Close</button>
          `;
          document.body.appendChild(modal);
          document.getElementById('close-aboutus-modal').onclick = function() {
            modal.remove();
          };
        };
      }
      ...
      modal.innerHTML = `
        ...
        <p>Stay tuned-in to the following series down below!</p>
          <ul style="list-style:none; padding:0;">
            ...
            <li><a href="https://supergt.net/en/" target="_blank" style="color:#39ff14; text-decoration:underline;">Super GT</a></li>
            <li><a href="https://gplb.com/" target="_blank" style="color:#39ff14; text-decoration:underline;">Grand Prix of Long Beach</a></li>
            <li><a href="https://www.petersen.org/" target="_blank" style="color:#39ff14; text-decoration:underline;">Petersen Museum</a></li>
            <li><a href="https://www.performanceracing.com/tradeshow" target="_blank" style="color:#39ff14; text-decoration:underline;">PRI</a></li>
            <li><a href="https://www.sema.org/" target="_blank" style="color:#39ff14; text-decoration:underline;">SEMA</a></li>
          </ul>
        <button id="close-featured-modal" style="margin-top:1.5rem; background:#39ff14; color:#222; border:none; border-radius:6px; padding:0.5rem 1.2rem; cursor:pointer; font-size:1rem;">Close</button>
      `;
      document.body.appendChild(modal);
