...
function renderDropdownMenu() {
  ...
  menu.style.minWidth = '180px';
    menu.innerHTML = `
      ...
      <div class="menu-item" style="cursor:pointer; color:#39ff14;" onclick="window.showCategoryInfo('featuredSeries')">🏎️ Be sure to follow the Featured Motorsports Series!</div>
    `;
    setTimeout(() => {
